...
```{r}
surveys = c("brt", "pps", "ppa", "ppr", "wld", "scs", "scc",
            "opp", "wlb", "sec", "qrp", "inf", "mng",
            "rla", "rlc", "pay", "tol", "gnl")
...
# This is the percentage of people having at least one missing value
...
# thus I will listwise delete participants with any missing values in the surveys.

processed_filtered = processed %>% 
  filter(if_all(starts_with(surveys), ~ !is.na(.)))
```
