...
renamed_data <- clean_data %>%
  ...
  dplyr::rename_with(
    ~ gsub("^general_satisfaction_", "gen_", .x),
...
burnout_data = renamed_data |> 
  select(brt_1, brt_2, brt_3, brt_4, anonym_id)
...
reverse_stressor_columns = c("rl_4", "rl_5", "rl_6", 
                              "rl_10", "rl_11", "rl_12")
...
general_satisfaction_data = renamed_data |> 
  select(contains("gen_"), anonym_id)
