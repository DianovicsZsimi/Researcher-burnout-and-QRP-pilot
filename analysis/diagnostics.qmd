...
lavInspect(jdr_measurement_fit_test, "cov.lv")

modificationIndices(jdr_measurement_fit_test, sort. = TRUE, maximum.number = 10)
```
...
jdr_composite_model <- '
  # Job Demands
  job_demands =~ wld + rla + wlb + pps

  # Job Resources
  job_resources =~ opp + mng + inf + scs + scc + sec + ppr
